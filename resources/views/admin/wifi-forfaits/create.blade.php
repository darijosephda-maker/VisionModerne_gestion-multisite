    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
                <form method="POST" action="{{ route('admin.wifi-forfaits.store') }}" class="space-y-4">
                    @csrf

                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nom du forfait</label>
                        <input type="text" name="nom_forfait" value="{{ old('nom_forfait') }}" required
                               placeholder="Ex : WiFi 1 jour, WiFi 1 semaine"
                    ...
                    <div>
                        ...
                        <input type="number" name="prix_cout" value="{{ old('prix_cout') }}" min="0" required
                               class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 text-sm">
