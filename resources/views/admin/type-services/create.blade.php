<x-admin-layout>
    ...
    <div class="py-8">
        <div class="max-w-lg mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('admin.type-services.store') }}" method="POST" class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6 space-y-6">
                @csrf

                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nom du service *</label>
                    <input type="text" name="nom" value="{{ old('nom') }}" required placeholder="ex: Reliure spirale"
